    ...
    public class TrangChuController : Controller
    {
        ...
        public ActionResult DangNhap(NongPham_Nhom2.Models.User li)
        {
            ...
            if (pass == li.MatKhau)
            {
                ...
                return RedirectToAction("TrangChu", "KhachHang",@ViewBag.user = ss.searchk(li));
                
            }
            else if (pass2 == li.MatKhau)
            {
                return RedirectToAction("QuanLySanPham", "NhanVien", @ViewBag.user = ss.searchnv(li));
            }
            @ViewBag.data = "invalide user";
            
            return RedirectToAction("DangNhap", "TrangChu");
        }
        public ActionResult TenUser()
        {
